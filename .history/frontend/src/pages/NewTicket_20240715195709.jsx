			...
			<section className="form">
				...
				<form onSubmit={onSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <textarea name="description" id="description" className="form-control" placeholder="Descrição" value={description} onChange={(e)=>setDescription(e.target.val)}></textarea>
                    </div>
				</form>
			</section>
		</>
